...
./bin/bootloader.asm.bin: ./bin/bl_primary.asm.bin ./bin/bl_secondary.asm.bin ./bin/bl_tertiary.asm.bin
	cat ./bin/bl_primary.asm.bin ./bin/bl_secondary.asm.bin > ./bin/blps.asm.bin
	cat ./bin/blps.asm.bin ./bin/bl_tertiary.asm.bin > ./bin/bootloader.asm.bin
...
./bin/bl_tertiary.asm.bin: ./src/bootloader/bl_tertiary.asm
	nasm -f bin -i ./src/bootloader/helpers/ ./src/bootloader/bl_tertiary.asm -o ./bin/bl_tertiary.asm.bin
